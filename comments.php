 ...
 * handled by a callback to minimal_stream_comment() which is
...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'minimal_stream' ),
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use minimal_stream_comment() to format the comments.
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'minimal_stream' ); ?></p>
	<?php endif; ?>
